...
export default function DoubtsSection() {
  ...
  return (
    <section id="doubts" className="relative overflow-hidden bg-gh-canvas">
      <div className="absolute -top-40 right-0 h-96 w-96 rounded-full bg-cyber-pink/5 blur-3xl lg:blur-[72px] pointer-events-none" />
      ...
      <div className="mx-auto max-w-7xl px-6 relative z-10">
        ...
        <div className="mx-auto max-w-3xl text-center mb-16">
          ...
          <h2 className="section-title mx-auto">
            Finished B.Tech / Degree / MCA? <span className="highlight">What next?</span>
          </h2>
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              <h3 className="mt-6 text-2xl font-extrabold text-gh-fg leading-tight">
                Get a <span className="highlight">Single Solution</span> for all queries at NSR Academy
              </h3>
