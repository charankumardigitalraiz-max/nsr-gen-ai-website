...
export default function HiringPartners() {
  ...
  return (
    <div className="relative overflow-hidden border-t border-b border-slate-100/80 bg-gh-canvas pt-10 pb-16">
      <div className="relative z-20 mx-auto mb-12 max-w-7xl px-6 text-center">
        <span className="mb-3 inline-flex items-center gap-1.5 rounded-full border border-gh-blue/15 bg-gh-blue/5 px-3 py-1 text-[9px] font-bold uppercase tracking-wider text-gh-blue">
          <Sparkles className="h-3.5 w-3.5" />
          Corporate Network
        </span>
        <h3 className="text-2xl font-extrabold leading-tight tracking-tight text-slate-800 sm:text-4xl">
          Where Our Graduates{' '}
