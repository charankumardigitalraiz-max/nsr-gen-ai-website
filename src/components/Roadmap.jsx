...
export default function Roadmap() {
  ...
  return (
    <section id="roadmap" className="relative overflow-hidden bg-gh-canvas">
      ...
      <div className="absolute top-1/2 right-1/4 h-[350px] w-[350px] rounded-full bg-gh-purple/5 blur-[120px] pointer-events-none" />

      <div className="mx-auto max-w-[95rem] px-6 relative z-10">

        {/* Section Header */}
        <div className="mx-auto max-w-3xl text-center mb-16">
          <span className="inline-flex items-center gap-1.5 rounded-full border border-gh-blue/15 bg-gh-blue/5 px-3 py-1 text-[9px] font-bold uppercase tracking-wider text-gh-blue mb-3">
            <Sparkles className="h-3.5 w-3.5" />
            Your Journey
          </span>
          <h2 className="text-2xl font-extrabold tracking-tight sm:text-4xl text-slate-800 leading-tight">
            Our Training-to-Placement <span className="bg-gradient-to-r from-gh-blue to-gh-purple bg-clip-text text-transparent">Milestones</span>
          </h2>
        ...
        <div className="relative mt-12">
          ...
          <div className="absolute top-10 left-[10%] right-[10%] h-[2px] bg-gradient-to-r from-gh-blue via-gh-purple to-cyber-pink hidden xl:block z-0 opacity-40" />
